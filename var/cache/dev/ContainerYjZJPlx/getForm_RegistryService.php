...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Form\\AdminDashboardFormType' => ['privates', 'App\\Form\\AdminDashboardFormType', 'getAdminDashboardFormTypeService', true],
            'App\\Form\\AdminLoginFormType' => ['privates', 'App\\Form\\AdminLoginFormType', 'getAdminLoginFormTypeService', true],
            'App\\Form\\BarcodeCreatorType' => ['privates', 'App\\Form\\BarcodeCreatorType', 'getBarcodeCreatorTypeService', true],
            'App\\Form\\BarcodeReaderFormType' => ['privates', 'App\\Form\\BarcodeReaderFormType', 'getBarcodeReaderFormTypeService', true],
            'App\\Form\\DashboardFormType' => ['privates', 'App\\Form\\DashboardFormType', 'getDashboardFormTypeService', true],
            'App\\Form\\NewItemType' => ['privates', 'App\\Form\\NewItemType', 'getNewItemTypeService', true],
            ...
            'App\\Form\\AdminDashboardFormType' => '?',
            'App\\Form\\AdminLoginFormType' => '?',
            'App\\Form\\BarcodeCreatorType' => '?',
            'App\\Form\\BarcodeReaderFormType' => '?',
            'App\\Form\\DashboardFormType' => '?',
            'App\\Form\\NewItemType' => '?',
